...
const fetchUrl = "https://bits-apogee.org/potfolio/projects/";
...
populate = (inform) => {
  ...
  function team_projects(input) {
    ...
    if (input == 4) {
      ...
      `;
        div.setAttribute(
          "onclick",
          `location.href='${main_arr[input][i].url}'`
        );
        document.getElementsByClassName("projects")[0].appendChild(div);
  ...
  slider.addEventListener("mousemove", (e) => {
    ...
    var slider_offset =
      (inner.scrollLeft / scroll_dist) * slide_bar_scroll_dist;
